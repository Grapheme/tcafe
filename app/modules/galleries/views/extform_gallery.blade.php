...
<div class="egg-dropzone dropzone" data-name="{{ $name }}" data-gallery_id="{{ (isset($gallery) && is_object($gallery)) ? (int)$gallery->id : '0' }}"<? if (isset($params) && is_array($params) && count($params)) {
